        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="text-center card-title mb-0 flex-grow-1">Add Sub-Category Form</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <form action="{{route('sub-category.create')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name" class="form-control" id="categoryName" placeholder="Enter Sub-Category Name">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
