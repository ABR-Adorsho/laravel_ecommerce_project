...
@section('mainContent')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Order Invoice Info</h4>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr class="top">
                                <td colspan="4">
                                    <table>
                                        <tr>
                                            <td class="title">
                                                <img src="{{asset('/')}}admin/assets/images/invoice-logo.png" style="width: 100%; max-width: 300px" />
                                            </td>
                            ...
                            @foreach($order->orderDetails as $orderDetail)
                                <tr class="item">
                                    ...
                                    <td style="text-align: center;">Tk. {{number_format($orderDetail->product_price)}}</td>
                                    <td style="text-align: right;">Tk. {{number_format($total = $orderDetail->product_quantity * $orderDetail->product_price)}}</td>
                                </tr>
                                @php($sum += $total)
                            @endforeach
                            <tr class="total">
                                ...
                                <td>Sub Total: Tk. {{number_format($sum)}}</td>
                            </tr>
                            <tr class="total">
                                <td colspan="3"></td>
                            ...
                            <tr class="total">
                                <td colspan="3"></td>
                                <td>Total Payable: Tk. {{number_format($sum + $tax + 100)}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
