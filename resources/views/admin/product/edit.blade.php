        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title text-center mb-0 flex-grow-1">Edit Product Form</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    ...
                    <form action="{{route('product.update', ['id' => $product->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="code"  value="{{$product->code}}" class="form-control" id="code" placeholder="Enter product code">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="number" name="regular_price"  value="{{$product->regular_price}}" class="form-control" id="regular_price" >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="number" name="selling_price"  value="{{$product->selling_price}}" class="form-control" id="selling_price" >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="number" name="stock_amount"  value="{{$product->stock_amount}}" class="form-control" id="selling_price" >
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control" name="short_description" id="description" >{{$product->short_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control summernote" name="long_description" id="description">{{$product->long_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                ...
                                <img src="{{asset($product->image)}}" class="img-fluid avatar-md rounded" alt="product_image">
                            </div>
                        </div>
